...
import org.usfirst.frc2471.Swerve.Filter;
/**
 *
 */
...
//            }
    ...
    public void drive( double x, double y, double r, double s, double _gyroAngle,
            ...
            boolean _fieldMove, boolean _fieldSteer )
    {
...
//        System.out.println("LF: " + (currentLF - prevLF) + " RF: " + (currentRF - prevRF) + " LR: " + (currentLR - prevLR) + " RR: " + (currentRR - prevRR));
