...
public class  DriveLoop extends Command {
    ...
    protected void execute() {
        ...
        double r =  Robot.oi.getJoystick1().getAxis(Joystick.AxisType.kZ);
        double s = -Robot.oi.getJoystick1().getAxis(Joystick.AxisType.kThrottle);  // kThrottle is the y of the right stick
