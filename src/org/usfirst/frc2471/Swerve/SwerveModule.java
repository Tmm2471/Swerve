...
public class SwerveModule implements Runnable {
    ...
    Thread t;
    Encoder twistEnc;
    ArduinoEncoder speedEnc;
    PIDController twistController;
    double twistOffset = 0.0;
    String name;
    static DashboardPID twistDashboardPID;
    
    public SwerveModule(String _name, SpeedController _speedController, ArduinoEncoder _speedEnc, SpeedController _twistController, Encoder _twistEnc) {
